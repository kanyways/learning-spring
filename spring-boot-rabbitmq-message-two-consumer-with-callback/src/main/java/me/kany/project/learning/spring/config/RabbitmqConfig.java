...
public class RabbitmqConfig {
    ...
    /**
     * firstConsumerDirectExchange: 创建消费者一的交换机<br/>
     *
     * @return
     * @author Jason.Wang
     */
    @Bean
    public DirectExchange firstConsumerDirectExchange() {
        return new DirectExchange(Constants.CONSUMER_FIRST_SINGLETON_EXCHANGE_NAME, true, false);
    }

    /**
     * secondConsumerDirectExchange: 创建消费者二的交换机<br/>
     *
     * @return
     * @author Jason.Wang
     */
    @Bean
    public DirectExchange secondConsumerDirectExchange() {
        return new DirectExchange(Constants.CONSUMER_SECOND_SINGLETON_EXCHANGE_NAME, true, false);
    }
    ...
    /**
     * consumerFirstSingletonDirectQueue: 创建消费者一队列<br/>
     *
     * @return
     * @author Jason.Wang
     */
    @Bean
    public Queue consumerFirstSingletonDirectQueue() {
        return QueueBuilder.durable(Constants.CONSUMER_FIRST_SINGLETON_QUEUE_NAME).build();
    }

    /**
     * consumerSecondSingletonDirectQueue: 创建消费者二队列<br/>
     *
     * @return
     * @author Jason.Wang
     */
    @Bean
    public Queue consumerSecondSingletonDirectQueue() {
        return QueueBuilder.durable(Constants.CONSUMER_SECOND_SINGLETON_QUEUE_NAME).build();
    }
    ...
    /**
     * firstConsumerExchangeBindOneQueue: 将消费者一绑定到消费者一的交换机和路由中<br/>
     *
     * @return
     * @author Jason.Wang
     */
    @Bean
    public Binding firstConsumerExchangeBindOneQueue() {
        return BindingBuilder.bind(consumerFirstSingletonDirectQueue()).to(firstConsumerDirectExchange())
            .with(Constants.CONSUMER_FIRST_SINGLETON_ROUTING_NAME);
    }

    /**
     * firstConsumerExchangeBindOneQueue: 将消费者二绑定到消费者二的交换机和路由中<br/>
     *
     * @return
     * @author Jason.Wang
     */
    @Bean
    public Binding secondConsumerExchangeBindOneQueue() {
        return BindingBuilder.bind(consumerSecondSingletonDirectQueue()).to(secondConsumerDirectExchange())
            .with(Constants.CONSUMER_SECOND_SINGLETON_ROUTING_NAME);
    }
}
