...
public class RabbitmqConsumer {
    ...
    /**
     * consumerDelayQueueReceiveListener: 延迟队列的消费者<br/>
     *
     * @param message
     * @param channel
     * @param tag
     ...
     * @author Jason.Wang
     */
    @RabbitListener(queues = Constants.CONSUMER_DELAY_QUEUE_NAME)
    public void consumerDelayQueueReceiveListener(String message, Channel channel,
        @Header(AmqpHeaders.DELIVERY_TAG) long tag) throws IOException {
        try {
            log.info("延迟队列消费者接收到消息：{}", message);
