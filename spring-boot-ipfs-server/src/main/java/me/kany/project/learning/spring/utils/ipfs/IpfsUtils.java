...
@Log4j2
@Component
@ConfigurationProperties(prefix = IpfsUtils.IPFS_PREFIX)
public class IpfsUtils {
    ...
    public String uploadFile(String filePath) throws IOException {
        //创建IPFS的服务
        IPFS ipfs = new IPFS(getNode());
        NamedStreamable.FileWrapper file = new NamedStreamable.FileWrapper(new File(filePath));
        MerkleNode addResult = ipfs.add(file).get(0);
        log.debug("upload file {} file info: {}", filePath, JSONObject.toJSONString(addResult));
    ...
    public String uploadFile(File file) throws IOException {
        ...
        log.debug("upload file {} file info: {}", file.getName(), JSONObject.toJSONString(addResult));
        return addResult.hash.toString();
    }
    ...
    public String uploadFile(InputStream inputStream) throws IOException {
        ...
        log.debug("upload InputStream file info: {}", JSONObject.toJSONString(addResult));
        return addResult.hash.toString();
    }
    ...
    public String uploadFile(byte[] data) throws IOException {
        ...
        MerkleNode addResult = ipfs.add(input).get(0);
        log.debug("upload byte[] file info: {}", JSONObject.toJSONString(addResult));
        return addResult.hash.toString();
    }
    ...
    public void downloadFile(String fileHash, String filePath) throws IOException {
        ...
        log.debug("get file from hash {},file info: {}", fileHash, JSONObject.toJSONString(filePointer));
