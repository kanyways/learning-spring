 ...
 * @author Jason.Wang
 */
public class JacksonStringTrimJsonDeserialize extends JsonDeserializer<String> {
    /**
    ...
    public String deserialize(JsonParser parser, DeserializationContext context) throws IOException, JacksonException {
        return StringUtils.trimSpaces(parser.getText(), SpacesType.EXCEPT_LINE_SPACES);
    }
}
